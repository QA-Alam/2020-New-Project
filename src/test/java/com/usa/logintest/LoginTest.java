...
/**	As a User i can click on sign-in BTN 
	As a User i can enter user name
	As a User i can enter password
	As a User i can click on submit btn
	As a User i can verify my page title 
	As a User i can closed the browser */
